...
PiyawatLoader.Name = "PiyawatLoader"
PiyawatLoader.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
PiyawatLoader.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

PiyawatMain.Name = "PiyawatMain"
PiyawatMain.Parent = SazaLoader
PiyawatMain.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
PiyawatMain.BorderColor3 = Color3.fromRGB(0, 255, 255)
PiyawatMain.BorderSizePixel = 2
PiyawatMain.Position = UDim2.new(0.345615327, 0, 0.329824567, 0)
PiyawatMain.Size = UDim2.new(0, 395, 0, 224)

PiyawatText.Name = "PiyawatText"
PiyawatText.Parent = SazaMain
PiyawatText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
PiyawatText.BackgroundTransparency = 1.000
PiyawatText.Position = UDim2.new(0.182278469, 0, -0.0625, 0)
PiyawatText.Size = UDim2.new(0, 200, 0, 50)
PiyawatText.Font = Enum.Font.GothamSemibold
PiyawatText.Text = "Piyawat"
PiyawatText.TextColor3 = Color3.fromRGB(180, 180, 180)
PiyawatText.TextSize = 14.000
...
SazaSystem.Name = "PiyawatSystem"
PiyawatSystem.Parent = SazaMain
PiyawatSystem.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
PiyawatSystem.BackgroundTransparency = 1.000
PiyawatSystem.BorderColor3 = Color3.fromRGB(27, 42, 53)
PiyawatSystem.Position = UDim2.new(0.301265836, 0, 0.566964269, 0)
PiyawatSystem.Size = UDim2.new(0, 156, 0, 49)
PiyawatSystem.Font = Enum.Font.GothamSemibold
PiyawatSystem.Text = "SazaSystem: Thanks for use Saza Hub, Stay Safe!"
PiyawatSystem.TextColor3 = Color3.fromRGB(180, 180, 180)
PiyawatSystem.TextSize = 15.000
...
if mobilesupported and game.PlaceId == 6284583030 and not pcsupported then
    ...
    wait(1)
    LoadingTXT.Text = "Thank for using Piyawat Hub"
    wait(1)
    SazaLoader:Destroy()
    wait(1)
